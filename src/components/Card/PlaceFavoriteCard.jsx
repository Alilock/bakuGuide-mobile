...
import {removeFavotires} from '../../features/FavoriteSlice/favoriteSlice';
const PlaceFavoriteCard = ({item}) => {
        ...
        <View style={styles.container}>
          <View style={styles.imageWrapper}>
            ...
            <View style={styles.imageWrapper.icon}>
              <TouchableOpacity onPress={() => dispatch(removeFavotires(item))}>
...
export default PlaceFavoriteCard;
